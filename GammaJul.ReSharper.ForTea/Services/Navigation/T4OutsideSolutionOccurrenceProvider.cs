...
namespace GammaJul.ReSharper.ForTea.Services.Navigation {
    ...
    public class T4OutsideSolutionOccurrenceProvider : IOccurrenceProvider
    {
        ...
        public IOccurrence MakeOccurrence([NotNull] FindResult findResult)
        {
            ...
            return (JetBrains.ReSharper.Feature.Services.Occurrences.IOccurrence)new T4OutsideSolutionOccurrence(rangeMarker);
        }
    }
